...
proc create_root_design { parentCell } {
  ...
  set enet1_gmii_rxd [ create_bd_port -dir O -from 3 -to 0 enet1_gmii_rxd ]
  set enet1_gmii_txd [ create_bd_port -dir O -from 3 -to 0 enet1_gmii_txd ]
  ...
  connect_bd_net -net Net [get_bd_pins processing_system7_0/ENET1_GMII_RXD] [get_bd_pins xlconcat_3/In0]
  ...
  connect_bd_net -net processing_system7_0_ENET1_GMII_TXD [get_bd_pins processing_system7_0/ENET1_GMII_TXD] [get_bd_pins xlconcat_2/In0]
  ...
  connect_bd_net -net xlconcat_2_dout [get_bd_ports enet1_gmii_txd] [get_bd_pins xlconcat_2/dout]
  connect_bd_net -net xlconcat_3_dout [get_bd_ports enet1_gmii_rxd] [get_bd_pins xlconcat_3/dout]
